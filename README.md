...
<img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=6,11,20&height=180&section=header&text=Apoorv%20Gupta&fontSize=42&fontColor=fff&animation=twinkling&fontAlignY=32&desc=Aspiring%20AI%2FML%20Engineer%20%7C%20Full-Stack%20Dev%20%7C%20CS%20Undergrad%20@%20VIT%20Bhopal&descAlignY=62&descSize=16"/>
...
class Apoorv {
public:
    string name           = "Apoorv Gupta";
    string university     = "VIT Bhopal";
    float  cgpa           = 8.69;
    vector<string> focus  = {"AI/ML", "Full-Stack", "LLMs"};
    string pronouns       = "he/him";

    vector<string> currentObsessions() {
        return {
    ...
    string funFact() {
        return "Top 1.4% in a national hackathon 🏆";
    }
};

int main() {
    Apoorv me;
    cout << "Welcome to " << me.name << "'s GitHub!" << endl;
    return 0;
}
```

- 🎓 B.Tech CS @ VIT Bhopal — **CGPA: 8.69**
...
### 👁️ OptaNex — AI Eye Care PWA
> Full-stack progressive web app for clinical-grade eye screening
...
[![Gmail](https://img.shields.io/badge/Gmail-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:ag5098015@gmail.com)
[![GitHub](https://img.shields.io/badge/GitHub-100000?style=for-the-badge&logo=github&logoColor=white)](https://github.com/APOORV-sys)
